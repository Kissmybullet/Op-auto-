...
URL = "http://142.93.209.247:8082/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "http://142.93.209.247:8082/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "http://142.93.209.247:8082/".format(FQDN)
else:
    URL = "http://142.93.209.247:8082/".format(FQDN)
