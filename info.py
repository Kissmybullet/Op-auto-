...
URL = "https://142.93.209.247.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://142.93.209.247.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://142.93.209.247.com/".format(FQDN)
else:
    URL = "https://142.93.209.247.com/".format(FQDN)
