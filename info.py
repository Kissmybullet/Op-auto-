...
URL = "https://filetolink.mknbotz.workers.dev".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filetolink.mknbotz.workers.dev".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filetolink.mknbotz.workers.dev".format(FQDN)
else:
    URL = "https://filetolink.mknbotz.workers.dev".format(FQDN)
